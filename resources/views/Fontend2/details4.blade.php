...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Laptop HP Pavilion Gaming 15-dk1074TX, Core i7-10750H(2.60 GHz, 12 MB),8GB RAM,512GB SSD,GeForce GTX 1650 4GB,15.6""FHD,Wlan ax+BT,Win 10 Home,1Y WTY_1K3U8PA - Hàng Chính Hãng</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/laptop/product-4.PNG" width="180px" height="250px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">17.890.000 VND</span></p>
