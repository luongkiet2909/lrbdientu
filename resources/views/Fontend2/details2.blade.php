...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Laptop Lenovo ThinkPad E14 20RAS01000 (Core i5-10210U/ 4GB DDR4 2666MHz/ 256GB M.2 2242 PCIe NVMe/ 14 FHD IPS/ Dos) - Hàng Chính Hãng</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/laptop/product-2.PNG" width="250px" height="250px">
								</div>
