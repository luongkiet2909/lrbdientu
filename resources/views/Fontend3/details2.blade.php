...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Tai Nghe Bluetooth Nhét Tai Apple AirPods 2 True Wireless - Hàng Chính Hãng VN/A</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/airpod/product-2.PNG" width="180px" height="220px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">3.490.000 VND</span></p>
