...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Hộp đựng tai nghe UAG Hard Case cho Airpods Pro</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/airpod/product-12.PNG" width="200px" height="200px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">900.000 VND</span></p>
