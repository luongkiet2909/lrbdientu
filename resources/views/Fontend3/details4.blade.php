...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Hộp Sạc Không Dây Cho Tai Nghe Apple Airpods - MR8U2VN/A - Hàng Chính Hãng</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/airpod/product-4.PNG" width="180px" height="250px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">890.000 VND</span></p>
