...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Tai Nghe Bluetooth Apple AirPods 2 True Wireless - MV7N2 - Nhập Khẩu Chính Hãng - Hộp Sạc Thường</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/airpod/product-3.PNG" width="180px" height="250px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">2.190.000 VND</span></p>
									...
									<p class="add-cart text-center"><a href="{{url('/')}}">Đặt hàng online</a></p>
								</div>
							</div>							
						</div>
