...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Tủ Lạnh Inverter LG GN-D255PS (255L) – Hàng Chính Hãng</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/tulanh/product-14.PNG" width="200px" height="200px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">6.989.000  VND</span></p>
