...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>Tủ lạnh Hitachi Inverter 509 lít R-FW650PGV8-GBK</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/tulanh/product-9.PNG" width="200px" height="200px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">18.439.000 VND</span></p>
