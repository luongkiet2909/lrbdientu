...
@section('main')
					<div id="wrap-inner">
						<div id="product-info">
							...
							<h3>MÁY GIẶT SẤY ELECTROLUX INVERTER 8 KG EWW8025DGWA - HÀNG CHÍNH HÃNG</h3>
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img src="img/maygiac/product-14.PNG" width="200px" height="200px">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									<p>Giá: <span class="price">10.289.000 VND</span></p>
